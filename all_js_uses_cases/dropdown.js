...
//indusry list array
var industryArr = ['all', 'alcohol', 'aeronautics', 'automotive', 'cosmetics', 'eCommerceInternet', 'education', 'electronics', 'fashion', 'financialservices', 'fmcg', 'foodRestaurants', 'foodBeverage', 'healthcare', 'hospitality', 'insurance', 'manufacturing', 'entertainment', 'personalcare', 'publishing', 'realestate', 'retail', 'sport', 'technology', 'tourism', 'transport', 'others'],
    industryFilter = ['alcohol,aeronautics,automotive,cosmetics,eCommerceInternet,education,electronics,fashion,financialservices,fmcg,foodRestaurants,foodBeverage,healthcare,hospitality,insurance,manufacturing,entertainment,personalcare,publishing,realestate,retail,sport,technology,tourism,transport,others ', 'alcohol', 'aeronautics', 'automotive', 'cosmetics', 'eCommerceInternet', 'education', 'electronics', 'fashion', 'financialservices', 'fmcg', 'foodRestaurants', 'foodBeverage', 'healthcare', 'hospitality', 'insurance', 'manufacturing', 'entertainment', 'personalcare', 'publishing', 'realestate', 'retail', 'sport', 'technology', 'tourism', 'transport', 'others']
